  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-14 grid gap-10 md:grid-cols-2 items-center">
      <div className="rise">
        ...
        <div className={`display text-[12rem] leading-none mt-4 ${bad ? "text-scan" : "text-accent"}`}>{p.g}</div>
      ...
      <div className="flex justify-center"><Radar values={p.s} labels={["SEO", "AI Search", "Trust", "Authority", "Discover"].slice(0, p.s.length)} size={360} /></div>
    </main>
  );
}
