...
export default function ExtensionPage() {
  return (
    <main className="mx-auto max-w-2xl px-4 sm:px-6 py-12">
      ...
      <p className="mt-4 text-lg text-ink-2">One click. It reads the whole page, boxes every element it finds, then grades SEO, AI search visibility, trust, authority and discoverability. Jev works out what kind of business it is first.</p>
