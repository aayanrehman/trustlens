      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-10">
        {sites.length === 0 && (
          <div className="max-w-3xl rise">
            <div className="eyebrow">SEO · AI search · Trust · Authority · Discoverability</div>
            <h1 className="display text-5xl sm:text-7xl mt-3 leading-[0.95]">Does your website read as an <span className="text-teal">authority</span> to your clients, and to AI?</h1>
            <p className="mt-5 text-lg text-ink-2 max-w-xl">Paste one URL for a scan, or two to five for a side-by-side against competitors. Jev detects what kind of business it is, then judges the signals your clients and AI assistants look for. Fractions of a cent per site.</p>
          </div>
        )}
